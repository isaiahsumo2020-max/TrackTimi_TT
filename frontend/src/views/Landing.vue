      ...
      <div class="max-w-7xl mx-auto px-6 grid lg:grid-cols-2 gap-16 items-center">
        ...
        <div class="space-y-8 animate-in fade-in slide-in-from-left-8 duration-1000">
          ...
          <div class="flex flex-col sm:flex-row gap-4">
            <router-link to="/register-org" class="px-10 py-5 bg-indigo-600 text-white rounded-[1rem] font-black text-sm uppercase tracking-widest shadow-2xl shadow-indigo-200 hover:bg-indigo-700 hover:-translate-y-1 transition-all flex items-center justify-center">
