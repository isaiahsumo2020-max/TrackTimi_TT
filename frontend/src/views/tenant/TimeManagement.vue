  ...
  <div class="min-h-screen bg-gradient-to-br from-slate-50 to-slate-100 p-4 md:p-6">
    ...
    <div class="max-w-6xl mx-auto">
      ...
      <div class="bg-white rounded-lg shadow-sm border border-slate-200 mb-6">
        <div class="flex gap-0">
          <button
            ...
            class="flex-1 px-6 py-4 font-bold text-center transition-colors uppercase text-sm"
          >
            📊 Overview
          </button>
          <button
      ...
      <div v-if="activeTab === 'overview'" class="space-y-6">
          ...
          <div class="bg-white rounded-2xl shadow-sm border border-slate-200 p-6 space-y-3">
            ...
            <div class="space-y-2 text-sm">
              <div class="flex justify-between items-center">
                <span class="text-slate-600">🍽️ Lunch</span>
              ...
              <div class="flex justify-between items-center">
                <span class="text-slate-600">🚻 Restroom</span>
        ...
        <div 
          v-if="todayActivity"
          class="rounded-2xl border-2 p-6 flex items-start gap-4"
          :class="{
        ...
        >
          <span class="text-3xl">{{ (todayActivity?.Total_Breaks || 0) > maxBreaksPerShift ? '⚠️' : '✅' }}</span>
          <div>
      ...
      <div v-if="activeTab === 'breaks'" class="space-y-6">
        ...
        <div v-else-if="!todayActivity || !todayActivity.Breaks_Summary || todayActivity.Breaks_Summary.length === 0" class="bg-white rounded-2xl shadow-sm border border-slate-200 p-8 text-center">
      ...
      <div v-if="activeTab === 'analytics'" class="space-y-6">
              ...
              <div v-for="(breakItem, idx) in todayActivity.Breaks_Summary" :key="idx" class="space-y-2">
                ...
                <div class="h-3 bg-slate-100 rounded-full overflow-hidden">
                  <div 
                    ...
                    :class="breakItem.type === 'lunch' ? 'bg-orange-500' : breakItem.type === 'regular' ? 'bg-blue-500' : 'bg-purple-500'"
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
          <div class="bg-green-50 border border-green-200 rounded-2xl p-6">
            <h4 class="font-black text-green-900 mb-4">✓ Good Practices</h4>
