<template>
  <div class="min-h-screen bg-gradient-to-br from-blue-50 to-primary-100 flex items-center justify-center p-4">
    <div class="bg-white rounded-lg shadow-xl w-full max-w-md p-8">
      ...
      <!-- Message -->
      <div v-if="message" :class="['mb-6 p-4 rounded-lg', messageType === 'success' ? 'bg-green-50 text-green-700' : 'bg-blue-50 text-blue-700']">
      ...
      <div v-if="verified" class="text-center">
        ...
        <h2 class="text-xl font-bold text-green-700 mb-4">Email Verified!</h2>
